...
python3 -m unittest tests/test_models/test_engine/test_filestorage.py
"""
import unittest
import pep8
import json
...
class TestFileStorage(unittest.TestCase):
    ...
    def setUp(self):
        """
        Defines the private class attributes __file_path and __objects back to
        'file.json' and {}
    ...
    def test_pep8_conformance(self):
        """ Tests that FileStorage follows PEP8 standards """
    ...
    def test_class_method_presence(self):
        """ Tests that the FileStorage methods are declared"""
    ...
    def test_class_attribute_presence(self):
        """ Tests that the FileStorage attributes are declared """
    ...
    def test_instance_method_presence(self):
        """ Tests that the FileStorage instance as the same methods"""
    ...
    def test_instance_attribute_presence(self):
        """ Tests that the FileStorage instance contains the same attributes"""
    ...
    def test_instantiation(self):
        """ Tests correct instantiation of object Storage """
    ...
    def new(self, obj):
        ...
        bm = BaseModel()
        storage.new(bm)
        self.assertEqual(FileStorage.__objects[bm.__class__.
                                               __name__+'.'+bm.id], bm)
